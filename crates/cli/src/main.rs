...
fn run() -> Result<()> {
    ...
    match command {
        ...
        Command::Up(args) => commands::up::run(args, dir),
        Command::Share(args) => commands::share::run_share(args, dir),
        Command::Receive(args) => commands::share::run_receive(args, dir),
        Command::Publisher(args) => commands::share::run_publisher(args),
