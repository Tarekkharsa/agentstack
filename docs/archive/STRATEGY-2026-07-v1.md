# AgentStack product strategy (v1 — superseded)

> **Status:** SUPERSEDED 2026-07-31 by strategy v2, now at the repository root
> as `STRATEGY.md`. This file is the historical record of the v1 direction —
> read it for rationale and lineage, never for current direction. The
> competitive-watch section moved into the new strategy.
>
...
1. **The bar it sets is authoring clarity.** In eve, capability nouns are user
   ...
   fail-closed underneath" is the standard.
2. **Tripwires that upgrade eve to a direct competitor**, each warranting a
