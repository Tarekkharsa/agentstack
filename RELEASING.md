...
- Push to GitHub and set the real repo slug everywhere it says `tarekkh/agentstack`
...
for t in aarch64-apple-darwin x86_64-apple-darwin \
  ...
  curl -fsSL "https://github.com/tarekkh/agentstack/releases/download/v0.1.0/agentstack-$t.tar.gz" | shasum -a 256
done
```
