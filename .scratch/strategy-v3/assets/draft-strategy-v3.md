# AgentStack product strategy (v3) — DRAFT

> **Status:** draft for adoption, produced by the strategy-v3 wayfinder effort
> (2026-08-02; rebuilt after the craftsman pivot and the code-grounded feature
> round). On adoption it replaces v2 (adopted 2026-07-31) as the operative
> strategy. The decision record lives in `.scratch/strategy-v3/`; once
> adopted, this document stands alone.
>
> **Current as of:** AgentStack 0.18.0-rc.2
>
> **Relationship to the other documents:** [`TODO.md`](TODO.md) is the only
> ordered work queue, re-seeded on adoption. [`CLAUDE.md`](CLAUDE.md) carries
> the binding product-experience and engineering rules.
> [`docs/design/automatic-delivery.md`](docs/design/automatic-delivery.md) is
> the operative delivery contract, amended on adoption per "On adoption"
> below. The activation-study kit is promoted from the archive to
> `docs/design/activation-study.md` as the instrument for the bar-met moment.
> v2 and everything older are history in git and `docs/archive/` — never
> direction.
...
The adoption commit carries four follow-throughs, none of them separate
decisions:
